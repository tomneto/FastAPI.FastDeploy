...
from api.controllers.new_controller import find_one, find_many, insert_one, update_one, update_many, replace_one, replace_many, delete_one, delete_many  # Example controller import
...
@route.post("/new_endpoint", description=loadDescription("new_collection", 'post'), name="New Post", tags=["New Tag"], response_model=responseModels.new_post_response_model)
...
@route.put("/new_endpoint", description=loadDescription("new_collection", 'put'), name="New Put", tags=["New Tag"], response_model=responseModels.new_put_response_model)
...
@route.patch("/new_endpoint", description=loadDescription("new_collection", 'patch'), name="New Patch", tags=["New Tag"], response_model=responseModels.new_patch_response_model)
